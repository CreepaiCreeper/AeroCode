      ...
      >
            ...
            {[
              {
                href: "/",
                label: "New Chat",
                icon: <Edit size={18} className="shrink-0" />,
              },
              {
                href: "/?mode=blueprint",
                label: "Make blueprint",
                icon: <Compass size={18} className="shrink-0" />,
              },
              {
                href: "/?mode=bughunter",
                label: "Bug hunter",
                icon: <Bug size={18} className="shrink-0" />,
              },
            ].map((item, index) => (
              <li key={index}>
                <Link
                ...
                >
                  ...
                  <span
                    className={`whitespace-nowrap transition-all duration-200 ${
                      isOpen
                        ? "md:opacity-0 md:w-0 md:pointer-events-none md:invisible"
                        : "opacity-100 visible"
                    }`}
                  >
                    {item.label}
        ...
        <div className="flex-1 px-1 py-4 border-t border-zinc-900 flex flex-col min-h-0 mb-1.5">
          <h1
            className={`text-xs font-semibold text-zinc-500 tracking-wider px-3 select-none uppercase mb-3 transition-all duration-200 ${
              isOpen
                ? "md:opacity-0 md:invisible md:h-0 md:mb-0"
                : "opacity-100 visible"
            }`}
          >
            Recents
        ...
        {authStatus && (
          <div className="mt-auto p-3 border-t border-zinc-800/60 bg-[#0a0a0b]/50 shrink-0 w-full min-h-14 flex items-center animate-fadeIn">
            <div
              className={`flex items-center w-full ${isOpen ? "md:justify-center" : "justify-between px-1"}`}
            >
