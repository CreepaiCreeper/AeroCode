...
const Home = () => {
  ...
  return (
    <div className="h-[100svh] bg-black text-white font-sans antialiased">
      {/* 1. Global Side Navigation Control Frame */}
      <Sidebar />

      <div className="md:pl-64 h-[100svh] flex flex-col items-center justify-center relative overflow-hidden px-4">
          ...
          <div className="w-full max-w-3xl">
            <div className="flex items-end bg-[#111112] border border-zinc-800/90 rounded-2xl p-2 pl-4 shadow-2xl focus-within:border-purple-500/80 focus-within:ring-2 focus-within:ring-purple-500/10 transition-all duration-300">
              <textarea
                ...
                placeholder={"Debug your code or make blueprint..."}
